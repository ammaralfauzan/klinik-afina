    ...
    <div>
      <style>{`
        .form-input {
          ...
          padding: 11px 14px; font-size: 13px; color: #f1e6ff;
          outline: none; transition: all 0.2s; box-sizing: border-box;
        }
        .form-input::placeholder { color: #4b5563; }
        .form-input:focus { border-color: rgba(168,85,247,0.6); background: rgba(168,85,247,0.08); box-shadow: 0 0 0 3px rgba(168,85,247,0.1); }
      ...
      <div style={{ marginBottom: "28px" }}>
        <h1 style={{ fontSize: "24px", fontWeight: 800, color: "#f1e6ff", margin: 0 }}>Registrasi Pasien</h1>
        <p style={{ fontSize: "13px", color: "#6b7280", margin: "4px 0 0" }}>Daftarkan pasien baru ke antrian</p>
      </div>
      ...
      <div style={{ maxWidth: "520px" }}>
        {success && (
          <div style={{
            ...
            <span style={{ fontSize: "13px", color: "#4ade80", fontWeight: 600 }}>Pasien berhasil didaftarkan!</span>
          </div>
        )}

        <div style={{
          background: "rgba(255,255,255,0.03)", borderRadius: "16px", padding: "28px",
          border: "1px solid rgba(168,85,247,0.15)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)",
          display: "flex", flexDirection: "column", gap: "20px"
        }}>
          <div>
            <label style={{ fontSize: "12px", fontWeight: 700, color: "#a855f7", textTransform: "uppercase", letterSpacing: "0.06em", display: "block", marginBottom: "8px" }}>Nama Pasien</label>
          ...
          <div>
            <label style={{ fontSize: "12px", fontWeight: 700, color: "#a855f7", textTransform: "uppercase", letterSpacing: "0.06em", display: "block", marginBottom: "8px" }}>Keluhan</label>
          ...
          <button className="submit-btn" onClick={handleSubmit} disabled={loading || !form.nama || !form.keluhan} style={{
